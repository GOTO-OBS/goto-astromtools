...
def astrom_task(infilepath):
    ...
    output = [filename, UT, JD, pre_med, post_med, pre_rms, post_rms, pre_chisq, post_chisq, fittime, xmatchtime, sourcedens]
    return output
...
"FITTIME", "XMATCHTIME", "SRCDENS"), dtype=("S", "S", "f8", "f8", "f8", "f8", "f8", "f8", "f8", "f8", "f8", "f8"))
